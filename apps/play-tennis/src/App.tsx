...
type Tab = 'home' | 'bracket' | 'playnow' | 'availability' | 'profile' | 'leaderboard' | 'help'

const VALID_TABS: Tab[] = ['home', 'bracket', 'playnow', 'availability', 'profile', 'leaderboard', 'help']
    ...
    <div className="app">
      <div className="screen">
        ...
        <nav className="bottom-tabs">
          ...
          <button className={`bottom-tab ${activeTab === 'availability' ? 'active' : ''}`} onClick={() => setActiveTab('availability')}>
            <svg className="tab-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
